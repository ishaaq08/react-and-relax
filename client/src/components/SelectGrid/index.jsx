...
const index = () => {
  ...
  const cardImages = [revision, revision, revision];

  const cardDescription = [`Fill in the blanks`, `Psuedocode`, `Test 3`];
  const links = [
    '/games/how-to-play/fill-in-the-blanks',
    '/games/how-to-play/coding-env',
    '/games/game3',
  ];
  const gameNames = ['Fill in the blanks', 'PseudoCode', 'Game 3'];
