  ...
  return (
    <div className="h-screen bg-[#023E8A]">
      ...
      <div className="board bg-white w-[45vw] mx-auto p-6 rounded-lg mt-6">
        {/* Timer */}
        <div className="timer-container rounded-full w-[30vw] mx-auto bg-gray-200 p-0 border-2 border-black mt-2">
          <div className="timer w-[500px]  flex gap-6 justify-center items-center text-black  mx-auto px-10 py-5">
            <h2
        ...
        {session % 2 !== 0 ? (
          ...
          <div className="session bg-white p-4 rounded-2xl mt-6 flex flex-col justify-center items-center">
            <h2>
              Well Done! Please have a rest and prepare yourself for the next
              set of questions!
            </h2>
