...
INSERT INTO fill_in_blanks (question) VALUES ('The root element for an HTML document is __________.');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (2, 'html', true);

-- Question 3: Metadata and links
INSERT INTO fill_in_blanks (question) VALUES ('The section of an HTML document reserved for metadata, scripts, and styles is called the __________.', 'easy', 'html');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (3, 'head', true);

-- Question 4: Visible content
INSERT INTO fill_in_blanks (question) VALUES ('The element that holds the main content of an HTML document, which is visible to the user, is the __________.',, 'easy', 'html');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (4, 'body', true);

-- Question 5: Emphasis
INSERT INTO fill_in_blanks (question) VALUES ('To emphasize a text in HTML, which is typically displayed in italic, you use the __________ tag.', 'easy', 'html');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (5, 'em', true);

-- Question 6: Strong emphasis
INSERT INTO fill_in_blanks (question) VALUES ('To provide strong emphasis on a text, which is typically displayed in bold, you use the __________ tag.', 'easy', 'html');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (6, 'strong', true);

-- Question 7: Lists
INSERT INTO fill_in_blanks (question) VALUES ('An ordered list in HTML is represented using the __________ tag.',, 'easy', 'html');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (7, 'ol', true);

-- Question 8: Tables
INSERT INTO fill_in_blanks (question) VALUES ('The HTML element used to create a table header cell is __________.', 'easy', 'html');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (8, 'th', true);

-- Question 9: Image insertion
INSERT INTO fill_in_blanks (question) VALUES ('To embed an image in an HTML document, you use the __________ tag.', 'easy', 'html');
INSERT INTO fib_Answers (question_id, answer, is_correct) VALUES (9, 'img', true);

-- Question 10: Anchor
INSERT INTO fill_in_blanks (question) VALUES ('To create a clickable link in an HTML document, the __________ element is used.', 'easy', 'html');
